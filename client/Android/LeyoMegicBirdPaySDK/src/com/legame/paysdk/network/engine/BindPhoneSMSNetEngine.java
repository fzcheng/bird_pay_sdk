 ...
 * @version 1.0
 */
public class BindPhoneSMSNetEngine extends BaseNetEngine {

	private static final String COMMAND = "bind_phone_sms";
	
	private String mSid;
	private String mPhone;
	
	public BindPhoneSMSNetEngine(String sid,String phone){
