 ...
 * @version 1.0
 */
public class SimpleResultData extends BaseResultData {

	private static final String TAG = SimpleResultData.class.getSimpleName();
	
	private String mExpectPageType;
	
	public SimpleResultData(String expectPageType){
		mExpectPageType = expectPageType;
	}
	
	@Override
	public String getExpectPageType() {
		return mExpectPageType;
	}
