...
//		alert("roleId:"+roleId);
		var s = GetNode();
//		alert("s:"+s);
		targetForm=document.getElementById("form1");
//		alert("11111");
		//动态修改表单的action属性
		targetForm.action="roleController.do?updateAuthority&rolefunctions=" + s + "&roleId=" + roleId;
//		alert("targetForm.action:"+targetForm.action);
		//提交表单
		targetForm.submit();
...
<form name="form1" id="form1" action="roleController.do?updateAuthority" method="post">
