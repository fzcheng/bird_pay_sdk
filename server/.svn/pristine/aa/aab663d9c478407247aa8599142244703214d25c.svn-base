 ...
 <body style="overflow-y: hidden" scroll="no">
  ...
  <div id="documentListtb" style="padding: 5px; height:25px">
   <div style="float: left;">
    <a href="#" class="easyui-linkbutton" plain="true" icon="icon-add" onclick="add('弹出框添加','systemController.do?addNews')">弹出框打开添加页面</a>
    <a href="#" class="easyui-linkbutton" plain="true" icon="icon-edit" onclick="addbytab()">TAB方式打开添加页面</a>
   </div>
  </div>
 </body>
