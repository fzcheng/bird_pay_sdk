...
public class DateUtil {
	...
	public static void main(String[] args) {
		...
		try {
			String gg = "{\"rspcode\":\"0\", \"msg\":\"s\", \"sign\":\"89E6B1E8C9DBD3F07D8754C108723299\", \"user\":{\"userId\":\"10073327\", \"name\":\"uujiioiiiiii\", \"nickname\":\"%E9%BB%98%E9%BB%98%E4%BA%86%E5%85%94%E5%AD%90%E4%BA%86\", \"sessionId\":\"4f6c4292062e4bfab220d3d13e99ef79\", \"channelId\":\"100\", \"createTime\":\"2013-02-28 09:12:41\", \"lastTime\":\"2013-02-28 09:12:41\"}}";
			
			System.out.println(URLDecoder.decode(gg, "utf-8"));
		} catch (UnsupportedEncodingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		
//		String name = "mayer1994";
//		String opass = "jianghu";
//		String newpass = UserService.encode_db(opass);
//		System.out.println(name + ":newpass:" + newpass);
		
		
		int randid = Math.abs((int) ((System.currentTimeMillis()) ^ 131807526));
		int randpwd = Math.abs((int) ((System.currentTimeMillis()) ^ 181807526));
	 ...
	 * @return
	 */
	public static int getDifferTime(String begin_time, String end_time) {
		if (begin_time == null || end_time == null) {
			return 0;
		}
	...
	public static int getBettwen(String earlystr, String lasterstr, int addMin) {
		Date early = strToDate(earlystr);
		Date laster = strToDate(lasterstr);
		if(early==null||laster==null){
			return 0;
		}
		int min = (int)(laster.getTime()-early.getTime())/60000;
	...
	//获取给定日期的年开始日期
	public static String getYearDay(String regdate){
		Calendar c = Calendar.getInstance();
	...
	public static String getyesterMinutenumber(int number) {
		Calendar cal = Calendar.getInstance();
