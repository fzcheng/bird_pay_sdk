...
//        System.out.println(calc.transInfixToPosfix("1+2*3+7.5-(4/2+8)/5"));
//        System.out.println("value is:"+calc.calc());
        
//        System.out.println(calc.transInfixToPosfix("110815.00047*2"));
//        System.out.println("value is:"+calc.calc());
//        System.out.println(calc.transInfixToPosfix("110815.125047*2"));
//        System.out.println("value is:"+calc.calc());
        
//        System.out.println(calc.transInfixToPosfix("((110815.0347)*2+10)/0"));
//        System.out.println("value is:"+calc.calc());
        
        
//        System.out.println(calc.transInfixToPosfix("0.02"));
//        System.out.println("value is:"+calc.calc());
//        System.out.println(calc.transInfixToPosfix("0.0"));
//        System.out.println("value is:"+calc.calc());
       
       System.out.println(calc.transInfixToPosfix("1.3E7+0.5"));   
       System.out.println("value is:"+calc.calc());
        Double dd=Double.parseDouble("1.35378957E7");
        
        System.out.println(Caculator.getDtoI(dd));
