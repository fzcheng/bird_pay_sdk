  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="jeecgDemoController.do?save">
			...
			<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
						<input name="birthday" class="Wdate" onClick="WdatePicker()" style="width: 150px"
				...
				<tr>
					...
					<td class="value">
						<input name="createTime" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" style="width: 150px"
							value="<fmt:formatDate value='${jgDemo.createTime }' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>"
