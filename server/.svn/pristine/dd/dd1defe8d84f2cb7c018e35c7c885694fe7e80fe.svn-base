  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="jpPersonController.do?save">
			...
			<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="age" name="age" ignore="ignore"
							   value="${jpPersonPage.age}" datatype="n">
				...
				<tr>
					...
					<td class="value">
						<input class="Wdate" onClick="WdatePicker()"  style="width: 150px" id="birthday" name="birthday" 
							   value="<fmt:formatDate value='${jpPersonPage.birthday}' type="date" pattern="yyyy-MM-dd"/>" datatype="*">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  style="width: 150px" id="createdt" name="createdt" ignore="ignore"
							     value="<fmt:formatDate value='${jpPersonPage.createdt}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="name" name="name" 
							   value="${jpPersonPage.name}" datatype="*">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="salary" name="salary" ignore="ignore"
							   value="${jpPersonPage.salary}" datatype="d">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
			</table>
