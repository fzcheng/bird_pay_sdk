...
import jeecg.demo.entity.test.CKEditorEntity;
...
import jeecg.system.service.RepairService;
...
public class RepairServiceImpl extends CommonServiceImpl implements RepairService{
  ...
  +"     url:\"cgReportController.do?getFields\","+"\r\n"
		...
		cgreport_item.setJsPlugIn("0");
		cgreport_item.setSqlPlugIn("0");
		...
		ticket.setJsPlugIn("$(\"input/[name=\'name\']\").change( function() { \r\n 这里可以写些验证代码 \r\n  var name = $(\"#name\").val();  \r\nalert(name);});");
		...
		price1.setJsPlugIn("0");
		price1.setSqlPlugIn("0");
...
//		表单[订单主信息] - 字段清单
        ...
        jform_order_main_order_date.setShowType("text");
        ...
        jform_leave_hol_dept.setLength(20);
        ...
        jform_leave_hol_dept.setDictField("departname");
		...
		//表单[动态报表配置抬头] - 字段清单
		CgFormHeadEntity jform_cgreport_head = commonDao.findByProperty(CgFormHeadEntity.class, "tableName", "jform_cgreport_head").get(0);
		...
		//表单[动态报表配置明细] - 字段清单
		CgFormHeadEntity jform_cgreport_item = commonDao.findByProperty(CgFormHeadEntity.class, "tableName", "jform_cgreport_item").get(0);
        ...
        jform_order_customer_sex.setShowType("text");
        ...
        jform_order_ticket_tickect_date.setShowType("text");
	...
	private void repairCkEditor() {
          ...
          String str = "<html><head><title></title><link href='plug-in/easyui/themes/default/easyui.css' id='easyuiTheme' rel='stylesheet' type='text/css' />" +
          		...
          		"<input name='id' type='hidden' value='${id?if_exists?html}' /> <input type='hidden' />" +
	...
	private void repairLog(){
		...
		TSLog log1 = new TSLog();
          ...
          log1.setOperatetime(DataUtils.parseTimestamp("2013-4-24 16:22:40", "yyyy-MM-dd HH:mm"));
          ...
          log2.setOperatetime(DataUtils.parseTimestamp("2013-4-24 17:12:22", "yyyy-MM-dd HH:mm"));
          ...
          log3.setOperatetime(DataUtils.parseTimestamp("2013-3-10 15:37:11", "yyyy-MM-dd HH:mm"));
          ...
          log4.setOperatetime(DataUtils.parseTimestamp("2013-3-10 15:38:33", "yyyy-MM-dd HH:mm"));
          ...
          log5.setOperatetime(DataUtils.parseTimestamp("2013-3-10 15:38:42", "yyyy-MM-dd HH:mm"));
          ...
          log7.setOperatetime(DataUtils.parseTimestamp("2013-3-10 15:39:02", "yyyy-MM-dd HH:mm"));
          ...
          log8.setOperatetime(DataUtils.parseTimestamp("2013-3-10 15:39:04", "yyyy-MM-dd HH:mm"));
          ...
          log9.setOperatetime(DataUtils.parseTimestamp("2013-3-10 15:39:30", "yyyy-MM-dd HH:mm"));
          ...
          log10.setOperatetime(DataUtils.parseTimestamp("2013-3-10 15:39:38", "yyyy-MM-dd HH:mm"));
          ...
          log11.setOperatetime(DataUtils.parseTimestamp("2013-3-10 15:39:40", "yyyy-MM-dd HH:mm"));
          ...
          log12.setOperatetime(DataUtils.parseTimestamp("2013-3-10 15:39:41", "yyyy-MM-dd HH:mm"));
          ...
          log13.setOperatetime(DataUtils.parseTimestamp("2013-3-10 15:39:42", "yyyy-MM-dd HH:mm"));
          ...
          log15.setOperatetime(DataUtils.parseTimestamp("2013-3-10 15:40:04", "yyyy-MM-dd HH:mm"));
          ...
          log16.setOperatetime(DataUtils.parseTimestamp("2013-3-10 15:40:44", "yyyy-MM-dd HH:mm"));
          ...
          log17.setOperatetime(DataUtils.parseTimestamp("2013-3-10 15:41:26", "yyyy-MM-dd HH:mm"));
          ...
          log18.setOperatetime(DataUtils.parseTimestamp("2013-3-10 15:41:38", "yyyy-MM-dd HH:mm"));
          ...
          log19.setOperatetime(DataUtils.parseTimestamp("2013-3-10 15:46:55", "yyyy-MM-dd HH:mm"));
          ...
          log20.setOperatetime(DataUtils.parseTimestamp("2013-3-10 15:48:47", "yyyy-MM-dd HH:mm"));
          ...
          log21.setOperatetime(DataUtils.parseTimestamp("2013-3-21 23:23:52", "yyyy-MM-dd HH:mm"));
          ...
          log22.setOperatetime(DataUtils.parseTimestamp("2013-3-21 23:26:22", "yyyy-MM-dd HH:mm"));
          ...
          log23.setOperatetime(DataUtils.parseTimestamp("2013-3-21 23:28:34", "yyyy-MM-dd HH:mm"));
          ...
          log24.setOperatetime(DataUtils.parseTimestamp("2013-3-22 8:25:07", "yyyy-MM-dd HH:mm"));
          ...
          log25.setOperatetime(DataUtils.parseTimestamp("2013-3-22 9:05:25", "yyyy-MM-dd HH:mm"));
          ...
          log26.setOperatetime(DataUtils.parseTimestamp("2013-3-22 9:09:05", "yyyy-MM-dd HH:mm"));
          ...
          log27.setOperatetime(DataUtils.parseTimestamp("2013-3-22 9:28:50", "yyyy-MM-dd HH:mm"));
          ...
          log28.setOperatetime(DataUtils.parseTimestamp("2013-3-22 10:32:59", "yyyy-MM-dd HH:mm"));
          ...
          log29.setOperatetime(DataUtils.parseTimestamp("2013-3-22 10:35:44", "yyyy-MM-dd HH:mm"));
          ...
          log30.setOperatetime(DataUtils.parseTimestamp("2013-3-22 10:41:46", "yyyy-MM-dd HH:mm"));
          ...
          log31.setOperatetime(DataUtils.parseTimestamp("2013-3-22 16:11:14", "yyyy-MM-dd HH:mm"));
          ...
          log32.setOperatetime(DataUtils.parseTimestamp("2013-3-22 21:49:43", "yyyy-MM-dd HH:mm"));
          ...
          log33.setOperatetime(DataUtils.parseTimestamp("2013-3-22 23:17:12", "yyyy-MM-dd HH:mm"));
          ...
          log34.setOperatetime(DataUtils.parseTimestamp("2013-3-22 23:27:22", "yyyy-MM-dd HH:mm"));
          ...
          log35.setOperatetime(DataUtils.parseTimestamp("2013-3-23 0:16:10", "yyyy-MM-dd HH:mm"));
          ...
          log36.setOperatetime(DataUtils.parseTimestamp("2013-3-23 0:22:46", "yyyy-MM-dd HH:mm"));
          ...
          log37.setOperatetime(DataUtils.parseTimestamp("2013-3-23 0:31:11", "yyyy-MM-dd HH:mm"));
          ...
          log38.setOperatetime(DataUtils.parseTimestamp("2013-3-23 14:23:36", "yyyy-MM-dd HH:mm"));
          ...
          log39.setOperatetime(DataUtils.parseTimestamp("2013-3-23 15:05:30", "yyyy-MM-dd HH:mm"));
          ...
          log40.setOperatetime(DataUtils.parseTimestamp("2013-3-23 15:05:42", "yyyy-MM-dd HH:mm"));
          ...
          log41.setOperatetime(DataUtils.parseTimestamp("2013-3-23 15:12:56", "yyyy-MM-dd HH:mm"));
          ...
          log42.setOperatetime(DataUtils.parseTimestamp("2013-3-23 15:13:23", "yyyy-MM-dd HH:mm"));
          ...
          log43.setOperatetime(DataUtils.parseTimestamp("2013-5-6 15:27:19", "yyyy-MM-dd HH:mm"));
          ...
          log44.setOperatetime(DataUtils.parseTimestamp("2013-7-7 15:16:05", "yyyy-MM-dd HH:mm"));
          ...
          log45.setOperatetime(DataUtils.parseTimestamp("2013-7-7 16:02:38", "yyyy-MM-dd HH:mm"));
          ...
          log46.setOperatetime(DataUtils.parseTimestamp("2013-7-7 16:07:49", "yyyy-MM-dd HH:mm"));
          ...
          log47.setOperatetime(DataUtils.parseTimestamp("2013-7-7 16:09:10", "yyyy-MM-dd HH:mm"));
          ...
          log48.setOperatetime(DataUtils.parseTimestamp("2013-7-7 16:11:49", "yyyy-MM-dd HH:mm"));
          ...
          log49.setOperatetime(DataUtils.parseTimestamp("2013-7-7 16:13:44", "yyyy-MM-dd HH:mm"));
          ...
          log50.setOperatetime(DataUtils.parseTimestamp("2013-7-7 16:16:52", "yyyy-MM-dd HH:mm"));
          ...
          log51.setOperatetime(DataUtils.parseTimestamp("2013-7-7 16:19:18", "yyyy-MM-dd HH:mm"));
          ...
          log52.setOperatetime(DataUtils.parseTimestamp("2013-7-7 16:27:05", "yyyy-MM-dd HH:mm"));
          ...
          log53.setOperatetime(DataUtils.parseTimestamp("2013-7-7 16:42:32", "yyyy-MM-dd HH:mm"));
          ...
          log54.setOperatetime(DataUtils.parseTimestamp("2013-7-7 16:44:38", "yyyy-MM-dd HH:mm"));
          ...
          log55.setOperatetime(DataUtils.parseTimestamp("2013-7-7 16:49:06", "yyyy-MM-dd HH:mm"));
          ...
          log56.setOperatetime(DataUtils.parseTimestamp("2013-7-7 16:50:51", "yyyy-MM-dd HH:mm"));
          ...
          log57.setOperatetime(DataUtils.parseTimestamp("2013-7-7 16:53:48", "yyyy-MM-dd HH:mm"));
          ...
          log58.setOperatetime(DataUtils.parseTimestamp("2013-7-7 16:56:45", "yyyy-MM-dd HH:mm"));
          ...
          log59.setOperatetime(DataUtils.parseTimestamp("2013-7-7 16:59:22", "yyyy-MM-dd HH:mm"));
          ...
          log60.setOperatetime(DataUtils.parseTimestamp("2013-7-7 17:22:42", "yyyy-MM-dd HH:mm"));
          ...
          log61.setOperatetime(DataUtils.parseTimestamp("2013-7-7 17:26:03", "yyyy-MM-dd HH:mm"));
          ...
          log63.setOperatetime(DataUtils.parseTimestamp("2013-7-7 17:35:02", "yyyy-MM-dd HH:mm"));
          ...
          log64.setOperatetime(DataUtils.parseTimestamp("2013-7-7 17:46:39", "yyyy-MM-dd HH:mm"));
          ...
          log65.setOperatetime(DataUtils.parseTimestamp("2013-7-7 17:55:01", "yyyy-MM-dd HH:mm"));
          ...
          log66.setOperatetime(DataUtils.parseTimestamp("2013-7-7 18:08:56", "yyyy-MM-dd HH:mm"));
          ...
          log67.setOperatetime(DataUtils.parseTimestamp("2013-7-7 18:13:02", "yyyy-MM-dd HH:mm"));
          ...
          log68.setOperatetime(DataUtils.parseTimestamp("2013-7-7 18:15:50", "yyyy-MM-dd HH:mm"));
          ...
          log69.setOperatetime(DataUtils.parseTimestamp("2013-7-7 18:28:42", "yyyy-MM-dd HH:mm"));
          ...
          log70.setOperatetime(DataUtils.parseTimestamp("2013-7-7 18:29:12", "yyyy-MM-dd HH:mm"));
          ...
          log71.setOperatetime(DataUtils.parseTimestamp("2013-7-7 18:30:12", "yyyy-MM-dd HH:mm"));
          ...
          log73.setOperatetime(DataUtils.parseTimestamp("2013-7-7 18:31:26", "yyyy-MM-dd HH:mm"));
          ...
          log74.setOperatetime(DataUtils.parseTimestamp("2013-3-20 23:03:06", "yyyy-MM-dd HH:mm"));
          ...
          log75.setOperatetime(DataUtils.parseTimestamp("2013-3-20 23:19:25", "yyyy-MM-dd HH:mm"));
          ...
          log76.setOperatetime(DataUtils.parseTimestamp("2013-3-21 20:09:02", "yyyy-MM-dd HH:mm"));
          ...
          log77.setOperatetime(DataUtils.parseTimestamp("2013-3-21 20:27:25", "yyyy-MM-dd HH:mm"));
          ...
          log78.setOperatetime(DataUtils.parseTimestamp("2013-3-21 20:44:40", "yyyy-MM-dd HH:mm"));
          ...
          log79.setOperatetime(DataUtils.parseTimestamp("2013-3-21 20:54:13", "yyyy-MM-dd HH:mm"));
          ...
          log80.setOperatetime(DataUtils.parseTimestamp("2013-3-21 21:01:54", "yyyy-MM-dd HH:mm"));
          ...
          log81.setOperatetime(DataUtils.parseTimestamp("2013-3-21 21:13:05", "yyyy-MM-dd HH:mm"));
          ...
          log82.setOperatetime(DataUtils.parseTimestamp("2013-3-21 21:15:07", "yyyy-MM-dd HH:mm"));
          ...
          log83.setOperatetime(DataUtils.parseTimestamp("2013-3-21 21:22:57", "yyyy-MM-dd HH:mm"));
          ...
          log84.setOperatetime(DataUtils.parseTimestamp("2013-3-21 21:23:12", "yyyy-MM-dd HH:mm"));
          ...
          log85.setOperatetime(DataUtils.parseTimestamp("2013-3-21 21:23:47", "yyyy-MM-dd HH:mm"));
          ...
          log86.setOperatetime(DataUtils.parseTimestamp("2013-3-21 21:25:09", "yyyy-MM-dd HH:mm"));
          ...
          log87.setOperatetime(DataUtils.parseTimestamp("2013-3-21 21:27:58", "yyyy-MM-dd HH:mm"));
          ...
          log88.setOperatetime(DataUtils.parseTimestamp("2013-3-21 21:29:04", "yyyy-MM-dd HH:mm"));
          ...
          log89.setOperatetime(DataUtils.parseTimestamp("2013-3-21 21:29:56", "yyyy-MM-dd HH:mm"));
          ...
          log90.setOperatetime(DataUtils.parseTimestamp("2013-3-21 21:30:08", "yyyy-MM-dd HH:mm"));
          ...
          log91.setOperatetime(DataUtils.parseTimestamp("2013-3-21 21:31:21", "yyyy-MM-dd HH:mm"));
          ...
          log92.setOperatetime(DataUtils.parseTimestamp("2013-3-21 21:36:03", "yyyy-MM-dd HH:mm"));
          ...
          log93.setOperatetime(DataUtils.parseTimestamp("2013-3-21 21:36:11", "yyyy-MM-dd HH:mm"));
          ...
          log94.setOperatetime(DataUtils.parseTimestamp("2013-3-21 21:37:16", "yyyy-MM-dd HH:mm"));
          ...
          log95.setOperatetime(DataUtils.parseTimestamp("2013-3-21 21:38:20", "yyyy-MM-dd HH:mm"));
          ...
          log96.setOperatetime(DataUtils.parseTimestamp("2013-3-21 21:43:51", "yyyy-MM-dd HH:mm"));
          ...
          log97.setOperatetime(DataUtils.parseTimestamp("2013-2-7 10:10:29", "yyyy-MM-dd HH:mm"));
          ...
          log98.setOperatetime(DataUtils.parseTimestamp("2013-2-7 11:07:26", "yyyy-MM-dd HH:mm"));
          ...
          log99.setOperatetime(DataUtils.parseTimestamp("2013-2-7 11:07:39", "yyyy-MM-dd HH:mm"));
          ...
          log100.setOperatetime(DataUtils.parseTimestamp("2013-2-7 11:07:54", "yyyy-MM-dd HH:mm"));
	...
	private void repairDemo() {
		TSDemo demo = new TSDemo();
				//复杂字符串文本读取，采用文件方式存储
		String html = new FreemarkerHelper().parseTemplate("/jeecg/system/txt/valid-code-demo.ftl",null);
	...
	private void repairUser() {
		...
		TSDepart RAndD = commonDao.findByProperty(TSDepart.class, "departname", "研发室").get(0);
	...
	private void repairUserRole() {
		TSRole admin  = commonDao.findByProperty(TSRole.class, "roleCode", "admin").get(0);
		TSRole manager  = commonDao.findByProperty(TSRole.class, "roleCode", "manager").get(0);
	...
	private void repairOperation() {
		  TSIcon back = commonDao.findByProperty(TSIcon.class, "iconName", "返回").get(0);
		  TSFunction function = commonDao.findByProperty(TSFunction.class, "functionName", "Demo示例").get(0);
	...
	private void repairType() {
		TSTypegroup icontype = commonDao.findByProperty(TSTypegroup.class, "typegroupname", "图标类型").get(0);
		TSTypegroup ordertype = commonDao.findByProperty(TSTypegroup.class, "typegroupname", "订单类型").get(0);
		TSTypegroup custom = commonDao.findByProperty(TSTypegroup.class, "typegroupname", "客户类型").get(0);
		TSTypegroup servicetype = commonDao.findByProperty(TSTypegroup.class, "typegroupname", "服务项目类型").get(0);
		TSTypegroup datatable = commonDao.findByProperty(TSTypegroup.class, "typegroupname", "数据表").get(0);
		TSTypegroup filetype = commonDao.findByProperty(TSTypegroup.class, "typegroupname", "文档分类").get(0);
		TSTypegroup sex = commonDao.findByProperty(TSTypegroup.class, "typegroupname", "性别类").get(0);
		TSTypegroup searchmode = commonDao.findByProperty(TSTypegroup.class, "typegroupname", "查询模式").get(0);
		TSTypegroup yesorno = commonDao.findByProperty(TSTypegroup.class, "typegroupname", "逻辑条件").get(0);
		TSTypegroup fieldtype = commonDao.findByProperty(TSTypegroup.class, "typegroupname", "字段类型").get(0);
...
//        commonDao.saveOrUpdate(leave);
	...
	private void repairMenu() {
		TSIcon pic = commonDao.findByProperty(TSIcon.class, "iconName", "图片").get(0);	
		TSIcon group_add = commonDao.findByProperty(TSIcon.class, "iconName", "组").get(0);	
		TSIcon pie = commonDao.findByProperty(TSIcon.class, "iconName", "饼图").get(0);	
		TSIcon folder = commonDao.findByProperty(TSIcon.class, "iconName", "文件夹").get(0);	
        System.out.println(pic.getIconPath());
		//begin--Author:tanghan  Date:20130722 for--  一级菜单  ---------------------
        ...
        //end--Author:tanghan  Date:20130722 for--  一级菜单  ---------------------
      
        
        //begin--Author:tanghan  Date:20130722 for--  系统管理  ---------------------
...
//        TSFunction typetabs = new TSFunction();
//		typetabs.setFunctionName("数据字典");
//		typetabs.setFunctionUrl("systemController.do?typeGroupTabs");
//		typetabs.setFunctionLevel((short)1);
//		typetabs.setFunctionOrder("7");
//		typetabs.setTSFunction(sys);
//		typetabs.setTSIcon(pic);
//        commonDao.saveOrUpdate(typetabs);
        ...
        //end--Author:tanghan  Date:20130722 for--  系统管理  ---------------------
        
        
        //begin--Author:tanghan  Date:20130722 for--  统计查询  ---------------------
        ...
        //end--Author:tanghan  Date:20130722 for--  统计查询  ---------------------
        
        //begin--Author:tanghan  Date:20130722 for--  智能表单  ---------------------
        ...
        //end--Author:tanghan  Date:20130722 for--  智能表单  ---------------------
        
//      begin--Author:tanghan  Date:20130722 for--  动态报表  ---------------------
        TSFunction formconfig1 = new TSFunction();
		formconfig1.setFunctionName("动态报表配置");
		formconfig1.setFunctionUrl("cgAutoListController.do?list&id=jform_cgreport_head");
        ...
        //end--Author:tanghan  Date:20130722 for--  动态报表  ---------------------
        
        //begin--Author:tanghan  Date:20130722 for--  系统监控  ---------------------
        ...
        //end--Author:tanghan  Date:20130722 for--  系统监控  ---------------------
        
        //begin--Author:tanghan  Date:20130722 for--  常用插件  ---------------------
		...
		excel.setFunctionUrl("jpPersonController.do?jpPerson");
		...
		uploadownload.setFunctionUrl("commonController.do?listTurn&turn=system/document/filesList");
		...
		Office.setFunctionUrl("plug-in/webOffice/webOffice-sample.html?isIframe");
        ...
        //end--Author:tanghan  Date:20130722 for--  常用插件  ---------------------
	}
