...
/**
 * SdkStatGameRemainId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class SdkStatGameRemainId implements java.io.Serializable {
	...
	/** default constructor */
	public SdkStatGameRemainId() {
	}

	/** full constructor */
	public SdkStatGameRemainId(Integer gameId, Date statDay) {
		this.gameId = gameId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SdkStatGameRemainId))
			return false;
		SdkStatGameRemainId castOther = (SdkStatGameRemainId) other;
