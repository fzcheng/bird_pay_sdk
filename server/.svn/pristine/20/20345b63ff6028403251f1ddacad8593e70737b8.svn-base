...
public class ExHtmlLinkTag extends TagSupport {
	/**
		 * 
		 */
	...
	public int doEndTag() throws JspException {
		try {
			...
			if (oConvertUtils.isIn("easyui", types)) {
				...
				sb.append("<script type=\"text/javascript\" src=\"plug-in/easyui/jquery.easyui.edatagrid.js\"></script>");
			...
			if (oConvertUtils.isIn("tools", types)) {
				// ----begin -----Author:周俊峰
				// ---日期：2013-8-25----for：添加用户自定义样式common.css-----
