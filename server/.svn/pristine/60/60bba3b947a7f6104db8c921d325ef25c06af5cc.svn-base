 ...
 <table class="formtable" cellpadding="0" cellspacing="1">
  <tr>
   <td width="10%" height="50" align="right">
    <span class="filedzt">下拉框AJAX联动：</span>
   </td>
   <td width="90%" class="value" colspan="3">
    <select style="width: 150px" name="proname" id="proname" onchange="getdemo(this.value);">
     <option value="">
      --- 请选择菜单 ---
     </option>
  ...
  <tr>
   <td height="50" align="right">
    <span class="filedzt">菜单项目：</span>
   </td>
   <td class="value" colspan="3" nowrap>
    <SPAN id="demo"></SPAN>
   </td>
  </tr>
 </table>
