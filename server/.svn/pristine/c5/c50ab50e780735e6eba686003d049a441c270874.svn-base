...
public class GameMain {
	public static void main(String[] args)throws Exception {
		...
		webapp.setContextPath("/game-jeecg");
		ResourceCollection resources = new ResourceCollection(new String[] {
		    "/Users/sunjaly/work/workspace/eclipse/project6/lab-jeecg/WebRoot", 
		    "/Users/sunjaly/work/workspace/eclipse/project6/lab-jeecg-ext/WebRoot", 
		    home+"/WebRoot", 
		});
