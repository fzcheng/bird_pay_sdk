  ...
  <div region="center" style="padding:1px;">
	...
	<div  id="tb2" style="height:30px;" class="datagrid-toolbar">
		<span style="float:left;">
			<a href="#" class="easyui-linkbutton" plain="true" icon="icon-add" onclick="add('录入','jeecgEasyUIController.do?addorupdate','jeecgEasyUIList')" id="">录入</a>
			<a href="#" class="easyui-linkbutton" plain="true" icon="icon-edit" onclick="update('编辑','jeecgEasyUIController.do?addorupdate','jeecgEasyUIList')" id="">编辑</a>
			<a href="#" class="easyui-linkbutton" plain="true" icon="icon-search" onclick="detail('查看','jeecgEasyUIController.do?addorupdate','jeecgEasyUIList')" id="">查看</a>
		</span>
		<span style="float:right">
		    <input id="jeecgEasyUIListsearchbox" class="easyui-searchbox"  data-options="searcher:jeecgEasyUIListsearchbox,prompt:'请输入关键字',menu:'#jeecgEasyUIListmm'"></input>
