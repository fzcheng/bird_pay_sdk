...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="webOfficeList" title="WebOffice例子" actionUrl="webOfficeController.do?datagrid" idField="id" fit="true">
   ...
   <t:dgCol title="文档内容" field="doccontent" hidden="false"></t:dgCol>
