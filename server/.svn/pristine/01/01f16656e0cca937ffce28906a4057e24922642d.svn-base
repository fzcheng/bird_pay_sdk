 ...
 *
 */
public class GetWoplusYqPm extends AbstractNotifyService<CmdGetWoplusPm> {
  ...
  protected Result execute(CmdGetWoplusPm cmd) {
    ...
    String smsPort = Cfg.cfg.getString("sdk.external.unicom.woplusofflineyouqu.sms.port");
    try {
      ...
      orderMmdo.setPayChannelCode(WOPLUS_OFFLINE_YOUQU);
  ...
  private String getSmsContent(String appName, final SdkWoplusOfflinePaySms paySms) {
    ...
    String content3 = Cfg.cfg.getString("sdk.external.unicom.woplusofflineyouqu.channelid");//channelId
    ...
    String content5 = Cfg.cfg.getString("sdk.external.unicom.woplusofflineyouqu.apptype");
    ...
    String content7 = Cfg.cfg.getString("sdk.external.unicom.woplusofflineyouqu.producttype");
    
    String content9 = Cfg.cfg.getString("sdk.external.unicom.woplusofflineyouqu.paytype");
    ...
    String srcStr = content1.trim() + content2.trim() + content3.trim() + content4.trim() +
        ...
        content10.trim() + Cfg.cfg.getString("sdk.external.unicom.woplusofflineyouqu.signkey1") +
        Cfg.cfg.getString("sdk.external.unicom.woplusofflineyouqu.signkey2");
