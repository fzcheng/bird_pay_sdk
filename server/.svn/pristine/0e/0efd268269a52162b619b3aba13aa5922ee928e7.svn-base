...
<table border="0" cellpadding="2" cellspacing="0" id="jeecgOrderCustom_table">
	...
	<c:if test="${fn:length(jeecgOrderProductList)  <= 0 }">
			...
			errormsg="订单产品明细的产品名称应该为6到10位" name="jeecgOrderProductList[0].gopProductName" maxlength="100" type="text" value=""  style="width:220px;" ></td>
			<td align="left"><input name="jeecgOrderProductList[0].gopCount" maxlength="" type="text" value=""  style="width:120px;" ></td>
			<td align="left">
<%--			<input name="jeecgOrderProductList[0].gopProductType" maxlength="3" type="text" value=""  style="width:120px;" >--%>
			<t:dictSelect field="jeecgOrderProductList[0].gopProductType" typeGroupCode="service" hasLabel="false" defaultVal="${poVal.gocSex}"></t:dictSelect>
			</td>
			<td align="left"><input name="jeecgOrderProductList[0].gopOnePrice" maxlength="" type="text" value=""  style="width:120px;" ></td>
			<td align="left"><input name="jeecgOrderProductList[0].gopSumPrice" maxlength="" type="text" value=""  style="width:120px;" ></td>
	...
	<c:if test="${fn:length(jeecgOrderProductList)  > 0 }">
		<c:forEach items="${jeecgOrderProductList}" var="poVal" varStatus="stuts">
			...
			<td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
			<td align="left"><input nullmsg="请输入订单产品明细的产品名称！" datatype="s6-10"
			errormsg="订单产品明细的产品名称应该为6到10位" name="jeecgOrderProductList[${stuts.index }].gopProductName" maxlength="100" type="text" value="${poVal.gopProductName}"  style="width:220px;" ></td>
			...
			<td align="left">
<%--			<input name="jeecgOrderProductList[${stuts.index }].gopProductType" maxlength="3" type="text" value="${poVal.gopProductType }"  style="width:120px;" >--%>
			<t:dictSelect field="jeecgOrderProductList[${stuts.index }].gopProductType" typeGroupCode="service" hasLabel="false" defaultVal="${poVal.gopProductType}"></t:dictSelect>
			</td>
