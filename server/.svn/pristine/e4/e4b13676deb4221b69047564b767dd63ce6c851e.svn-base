...
function setInformation(name,id){
	addOneTab(name+'游戏资讯设置','sdkInformation.do?list2&gameId='+id);
}
</script>
 <div class="easyui-layout" fit="true">
 <div region="center" style="padding:1px;">
  <t:datagrid name="sdkInformationList" title="游戏资讯" actionUrl="sdkInformation.do?datagrid"  idField="id"  fit="true">
   ...
   <t:dgFunOpt title="设置"  funname="setInformation(name,id)" ></t:dgFunOpt>    
