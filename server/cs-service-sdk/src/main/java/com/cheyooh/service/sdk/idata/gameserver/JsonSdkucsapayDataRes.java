...
public class JsonSdkucsapayDataRes {
	...
	public String toString() {
		return "JsonSdkucsapayDataRes [tradeId=" + tradeId + ", tradeTime="
				+ tradeTime + ", orderId=" + orderId + ", gameId=" + gameId
				+ ", amount=" + amount + ", payType=" + payType
				+ ", attachInfo=" + attachInfo + ", orderStatus=" + orderStatus
