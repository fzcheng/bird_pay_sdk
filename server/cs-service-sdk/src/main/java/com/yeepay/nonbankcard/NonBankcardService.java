...
public class NonBankcardService {
	...
	public static NonBankcardPaymentResult pay(String p2_Order,
		...
		try {
			// 发起支付请求
			log.info("Begin http communications: "+annulCardReqURL+",request params[" + reqParams+ "]");
			responseStr = HttpUtils.URLPost(annulCardReqURL, reqParams);
			log.info("End http communications: "+annulCardReqURL+", responseStr:" + responseStr);
		} catch (Exception e) {
	...
	public static void verifyCallback(String r0_Cmd, 
		...
		log.debug("Recv payment result:[r0_Cmd=" + r0_Cmd + 
				  					 ";r1_Code="+ r1_Code +
				  					 ";p1_MerId=" + p1_MerId + 
				  					 ";p2_Order=" + p2_Order +
				  					 ";p3_Amt=" + p3_Amt +
