  ...
  <t:formvalid formid="formobj" layout="div" dialog="true" action="systemController.do?saveType">
   ...
   <fieldset class="step">
    ...
    <div class="form">
     ...
     <!-- 
     <input name="typecode" class="inputxt" ajaxurl="systemController.do?checkType&code=${type.typecode }&typeGroupCode=${type.TSTypegroup.typegroupcode}"  value="${type.typecode }"  datatype="/^[a-zA-Z]{1}\w{2,9}$/">
     -->
