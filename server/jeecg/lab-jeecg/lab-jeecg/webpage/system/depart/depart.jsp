...
<html>
 <head>
  ...
  <script type="text/javascript">
	$(function() {
		$('#cc').combotree({
			url : 'systemController.do?setPFunction'
		});
	});
</script>
 </head>
  ...
  <t:formvalid formid="formobj" layout="div" dialog="true" action="systemController.do?saveDepart">
   ...
   <fieldset class="step">
    <div class="form">
     ...
     <input name="departname" class="inputxt" value="${depart.departname }" datatype="s3-10">
     <span class="Validform_checktip">部门名称在3~10位字符</span>
    </div>
    <div class="form">
      <label class="Validform_label">
      职能描述:
