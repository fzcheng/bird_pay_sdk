  ...
  <table cellpadding="0" cellspacing="1" class="formtable">
   <tbody>
    ...
    <tr>
     ...
     <td class="value">
      <t:upload name="instruction" dialog="false" queueID="instructionfile" view="true" auto="true" uploader="systemController.do?saveFiles" extend="pic" id="instruction" formData="documentTitle"></t:upload>
     </td>
    </tr>
    <tr>
