	...
	<table width="1123" border="0" cellpadding="1" cellspacing="3">
		<tr bgcolor="#8CBFE9">
			<td height="15" valign="top" class="downSide">
				<font size="-1">&nbsp;&nbsp; 文档编号:</font>
				<input name="DocID" value="${docData.docid}" size="14">
				<span class="STYLE1"> | </span> 
				<font size="-1">&nbsp;&nbsp; 标 题:</font>
				<input name="DocTitle" value="${docData.doctitle}" size="14">
				<span class="STYLE1"> | </span>
				<font size="-1">&nbsp;&nbsp;&nbsp;文件格式: </font>
				<select name="doctype" size="1" id="doctype" ${docId!=''?"disabled='true'":""} onchange="newDoc()">
					<option value="doc" ${docData.doctype=='doc'?"selected='selected'":""}>
						Word
					</option>
					<option value="xls" ${docData.doctype=='xls'?"selected='selected'":""}>
						Excel
					</option>
					<option value="ppt" ${docData.doctype=='ppt'?"selected='selected'":""}>
						Powerpoint
					</option>
					<option value="wps" ${docData.doctype=='wps'?"selected='selected'":""}>
						wps
					</option>
				</select>
				<span class="STYLE1">|</span>
				<input name="button9" type="button" onClick="return SaveDoc()" value="上传到服务器" classs="rollout">
				<span class="STYLE1">|</span>
...
<!-- -----------------------------== 装载weboffice控件 ==--------------------------------- -->
<SCRIPT src="plug-in/webOffice/LoadWebOffice.js"></SCRIPT>
<!-- --------------------------------== 结束装载控件 ==----------------------------------- -->
			</td>
		</tr>
	</table>
