...
<body>
	<form id="formobj" action="jeecgOrderMainController.do?save" name="formobj" method="post">
		...
		<table cellpadding="0" cellspacing="1" class="formtable">
			<tr>
				...
				<td class="value">
					<input class="inputxt" id="goOrderCode" name="goOrderCode" datatype="*" value="${jeecgOrderMainPage.goOrderCode}"/>
				</td>
				<td align="right">
			...
			<tr>
				...
				<td class="value">
					<input class="inputxt" id="goTelphone" name="goTelphone" 
						   value="${jeecgOrderMainPage.goTelphone}" datatype="m" errormsg="手机号码不正确!" 	ignore="ignore">
				</td>
				<td align="right">
			...
			<tr>
				...
				<td class="value">
					<input class="inputxt" id="goAllPrice" name="goAllPrice" value="${jeecgOrderMainPage.goAllPrice}" datatype="d">
				</td>
				<td align="right">
			...
			<tr>
				...
				<td class="value" colspan="3">
					<input class="inputxt" id="goContent" name="goContent" value="${jeecgOrderMainPage.goContent}">
				</td>
			</tr>
		</table>
							...
							<c:if test="${fn:length(jeecgOrderProductList)  <= 0 }">
								<tr>
									...
									<td align="left"><input nullmsg="请输入订单产品明细的产品名称！"
										...
										name="jeecgOrderProductList[0].gopProductName" maxlength="100"
										type="text" value=""></td>
									<td align="left"><input
										name="jeecgOrderProductList[0].gopCount" maxlength=""
										type="text" value=""></td>
									<td align="left"><t:dictSelect
											field="jeecgOrderProductList[0].gopProductType"
											typeGroupCode="service" hasLabel="false"
											defaultVal="${poVal.gocSex}"></t:dictSelect></td>
									<td align="left"><input
										name="jeecgOrderProductList[0].gopOnePrice" maxlength=""
										type="text" value=""></td>
									<td align="left"><input
										name="jeecgOrderProductList[0].gopSumPrice" maxlength=""
										type="text" value=""></td>
									<td align="left"><input
										name="jeecgOrderProductList[0].gopContent" maxlength="200"
										type="text" value=""></td>
								</tr>
							</c:if>
							<c:if test="${fn:length(jeecgOrderProductList)  > 0 }">
								<c:forEach items="${jeecgOrderProductList}" var="poVal"
									varStatus="stuts">
									<tr>
										<td align="center"><input style="width: 20px;"
											type="checkbox" name="ck" /></td>
										<td align="left"><input nullmsg="请输入订单产品明细的产品名称！"
											datatype="s6-10" errormsg="订单产品明细的产品名称应该为6到10位"
											name="jeecgOrderProductList[${stuts.index }].gopProductName"
											maxlength="100" type="text" value="${poVal.gopProductName}"></td>
										<td align="left"><input
											name="jeecgOrderProductList[${stuts.index }].gopCount"
											maxlength="" type="text" value="${poVal.gopCount }"></td>
										<td align="left"><t:dictSelect
												field="jeecgOrderProductList[${stuts.index }].gopProductType"
												typeGroupCode="service" hasLabel="false"
												defaultVal="${poVal.gopProductType}"></t:dictSelect></td>
										<td align="left"><input
											name="jeecgOrderProductList[${stuts.index }].gopOnePrice"
											maxlength="" type="text" value="${poVal.gopOnePrice }"></td>
										<td align="left"><input
											name="jeecgOrderProductList[${stuts.index }].gopSumPrice"
											maxlength="" type="text" value="${poVal.gopSumPrice }"></td>
										<td align="left"><input
											name="jeecgOrderProductList[${stuts.index }].gopContent"
							...
							<c:if test="${fn:length(jeecgOrderCustomList)  <= 0 }">
								<tr>
									<td align="center"><input style="width: 20px;"
										type="checkbox" name="ck" /></td>
									<td align="left"><input
										name="jeecgOrderCustomList[0].gocCusName" maxlength="50"
										type="text"></td>
									<td align="left"><t:dictSelect
											field="jeecgOrderCustomList[0].gocSex" typeGroupCode="sex"
											hasLabel="false" defaultVal="${jgDemo.sex}"></t:dictSelect></td>
									<td align="left"><input
										name="jeecgOrderCustomList[0].gocIdcard" maxlength="32"
										type="text"></td>
									<td align="left"><input
										name="jeecgOrderCustomList[0].gocPassportCode" maxlength="32"
										type="text"></td>
									<td align="left"><input
										name="jeecgOrderCustomList[0].gocBussContent" maxlength="100"
										type="text"></td>
									<td align="left"><input
										name="jeecgOrderCustomList[0].gocContent" maxlength="200"
										type="text"></td>
								</tr>
							</c:if>
							<c:if test="${fn:length(jeecgOrderCustomList)  > 0 }">
								<c:forEach items="${jeecgOrderCustomList}" var="poVal"
									varStatus="stuts">
									<tr>
										<td align="center"><input style="width: 20px;"
											type="checkbox" name="ck" /></td>
										<td align="left"><input
											name="jeecgOrderCustomList[${stuts.index }].gocCusName"
											maxlength="50" type="text" value="${poVal.gocCusName }"></td>
										<td align="left"><t:dictSelect
												field="jeecgOrderCustomList[${stuts.index }].gocSex"
												typeGroupCode="sex" hasLabel="false"
												defaultVal="${poVal.gocSex}"></t:dictSelect></td>
										<td align="left"><input
											name="jeecgOrderCustomList[${stuts.index }].gocIdcard"
											maxlength="32" type="text" value="${poVal.gocIdcard }"></td>
										<td align="left"><input
											name="jeecgOrderCustomList[${stuts.index }].gocPassportCode"
											maxlength="32" type="text" value="${poVal.gocPassportCode }"></td>
										<td align="left"><input
											name="jeecgOrderCustomList[${stuts.index }].gocBussContent"
											maxlength="100" type="text" value="${poVal.gocBussContent }"></td>
										<td align="left"><input
											name="jeecgOrderCustomList[${stuts.index }].gocContent"
	...
	<table style="display: none">
		<tbody id="add_jeecgOrderProduct_table_template">
			<tr>
				...
				<td align="left"><input nullmsg="请输入订单产品明细的产品名称！"datatype="s6-10" errormsg="订单产品明细的产品名称应该为6到10位"
					name="jeecgOrderProductList[#index#].gopProductName"
					maxlength="100" type="text" ></td>
				<td align="left">
					<input name="jeecgOrderProductList[#index#].gopCount" maxlength="" type="text" >
				</td>
				<td align="left">
					<select	name="jeecgOrderProductList[#index#].gopProductType">
						<option value="1">特殊服务</option>
						<option value="2">普通服务</option>
					</select>
				</td>
				<td align="left">
					<input	name="jeecgOrderProductList[#index#].gopOnePrice" maxlength=""	type="text" >
				</td>
				<td align="left">
				    <input	name="jeecgOrderProductList[#index#].gopSumPrice" maxlength="" type="text" >
				</td>
				<td align="left">
					<input	name="jeecgOrderProductList[#index#].gopContent" maxlength="200"type="text" >
				</td>
			</tr>
		</tbody>
		<tbody id="add_jeecgOrderCustom_table_template">
			<tr>
				...
				<td align="left">
					<input name="jeecgOrderCustomList[#index#].gocCusName" maxlength="50" type="text" >
				</td>
				<td align="left">
					<select	name="jeecgOrderCustomList[#index#].gocSex">
						<option value="0">男性</option>
						<option value="1">女性</option>
					</select>
				</td>
				<td align="left">
					<input name="jeecgOrderCustomList[#index#].gocIdcard" maxlength="32" type="text" >
				</td>
				<td align="left">
					<input name="jeecgOrderCustomList[#index#].gocPassportCode" maxlength="32" type="text" >
				</td>
				<td align="left">
					<input name="jeecgOrderCustomList[#index#].gocBussContent" maxlength="100" type="text" >
				</td>
				<td align="left">
					<input	name="jeecgOrderCustomList[#index#].gocContent" maxlength="200"	type="text" >
				</td>
			</tr>
		</tbody>
	</table>
