...
<div id="jeecgOrderMainListNoTagtb" style="padding: 3px; height: auto">
	<div style="height: 30px;" class="datagrid-toolbar">
		<span style="float: left;">
			<a href="#"	class="easyui-linkbutton" plain="true" icon="icon-add"	onclick="add('录入(无标签)','jeecgOrderMainNoTagController.do?addorupdateNoTag','jeecgOrderMainListNoTag')">录入</a>
			<a href="#" class="easyui-linkbutton" plain="true" icon="icon-edit"	onclick="update('编辑(无标签)','jeecgOrderMainNoTagController.do?addorupdateNoTag','jeecgOrderMainListNoTag')">编辑</a>
		</span>
	</div>
</div>