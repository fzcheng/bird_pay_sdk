...
/**
 * SdkOrderMo9 entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "sdk_order_mo9", catalog = "game_sdk")
public class SdkOrderMo9 implements java.io.Serializable {
	...
	private String notifyCl;
	private String notifyCurrency;
	...
	/** minimal constructor */
	public SdkOrderMo9(Timestamp reqTime, String reqPartner, String reqSeller,
			String reqOutTradeNo, String reqSubject, String reqBody,
			String reqCl, String reqCurrency, Float reqTotalFee,
			String reqNotifyUrl) {
	...
	public SdkOrderMo9(Timestamp reqTime, String reqPartner, String reqSeller,
			String reqOutTradeNo, String reqSubject, String reqBody,
			String reqCl, String reqCurrency, Float reqTotalFee,
			String reqNotifyUrl, Timestamp notifyTime,
			String notifyTradeStatus, Float notifyTotalFee, String notifyCl,
			String notifyCurrency, String notifySubject,
		...
		this.notifyCl = notifyCl;
		this.notifyCurrency = notifyCurrency;
	...
	@Column(name = "req_cl", nullable = false, length = 16)
	...
	@Column(name = "req_currency", nullable = false, length = 16)
	...
	@Column(name = "notify_cl", length = 16)
	public String getNotifyCl() {
		return this.notifyCl;
	}

	public void setNotifyCl(String notifyCl) {
		this.notifyCl = notifyCl;
	}

	@Column(name = "notify_currency", length = 16)
	public String getNotifyCurrency() {
		return this.notifyCurrency;
	}

	public void setNotifyCurrency(String notifyCurrency) {
		this.notifyCurrency = notifyCurrency;
	}
