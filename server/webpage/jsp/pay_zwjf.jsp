...
<div class="main">
    ...
    <div class="box_border">
        <div class="box_inner">
          ...
          <ol class="box_steps">
                <li>
                    <div class="box_steps_bx">
                        <div class="box_steps_ct">
                            <em class="box_step_num">1</em>
                            <span class="box_step_words">
                            	
                            	请编辑短信<em class="color_red">${sendcontent}</em>发送到<em class="color_red">10658999</em>
                            </span>
                        </div>
                        <div class="box_steps_next"><span></span></div>
                    </div>
            </li>
                <li>
                    <div class="box_steps_bx">
                        <div class="box_steps_ct">
                            <em class="box_step_num">2</em>
                            <span class="box_step_words">
                            	接收确认短信,并在半小时内回复<em class="color_red">2</em>位数字确认
                ...
                <li>
                    <div class="box_steps_bx">
                        <div class="box_steps_ct">
                            <em class="box_step_num">3</em>
                            <span class="box_step_words">
                            	接收<em class="color_red">10</em>位虚拟码信息,并回填点击“<em class="color_red">确认购买</em>”按钮
        ...
        <!-- 
          <table cellpadding="0" cellspacing="0" class="box_table">
                <tbody><tr>
                    <th width="114">业务名称</th>
                    <th width="100">业务资费</th>
                    <th width="130">充值帐号</th>
                    <th width="191">订单号</th>
                    <th width="194">备注信息</th>
                </tr>
                <tr>
        ...
        -->
            ...
            <div class="box_lg">
              ...
              <form name="form1" method="post" action="http://leyo.magicbirds.cn/dispatchJsp/CmccZwjfServlet" id="form1">
                <table class="box_lg_table">
                    <tbody>
                    
                     <tr>
                        <td>
                            <input type="text" name="orderNo" id="orderNo" style="display:none" value=${orderNo} />
                        </td>
                    </tr>
                    
                    <tr>
                        <td width="150"><label>短信虚拟码：</label></td>
                        <td>
                            <!-- <input type="text" class="box_lg_code" /> -->
                            <input name="virtualCode" id="virtualCode" class="box_lg_code" type="number" maxlength="10"/>
                        </td>
                    </tr>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      	<td>
                            <!--<button  data-event="goumai" data-align="top right" class="box_lg_bt" id="goumai" onclick="next()">确认购买</button>-->
                            <!--<button  data-event="goumaiing" data-align="top right" class="box_lg_bt" id="goumaiing" onclick="next()" style="display:none;" >订购中，请稍后</button>-->

                        <!-- <a href="javascript:void(0);" class="box_lg_bt">确认订购</a> -->
                            <a data-align="top right" class="box_lg_bt" id="goumai" onclick="next()">确认购买</a>
                            <a data-align="top right" class="box_lg_bt" id="goumai_ing" style="display:none;">购买中，请稍后 …</a>
                          <!-- <div class="box_lg_load" style="display:none;" id="orader_ing">
                                <b></b>订购中，请稍后 …
                                <a class="box_lg_close" href="javascript:void(0);">x</a>
                            </div>-->
...
<div class="box_recomend">
   	<h3>中国移动温馨提示：</h3>
    <p><strong class="color_red">1、支付金额由中国移动代收； 恶意投诉将会影响手机账号正常使用</strong><br />
    <p><strong class="color_red">2、如需进行投诉建议，请联系移动支付客服电话：4000968662。</strong><br />
      3、用户使用中国移动手机账户支付，无免费试用，支付成功，即刻扣除积分。</p>
    <p>4、业务使用中会产生0.1元/条（或按照您参与的运营商话费套餐标准）短信通信费，具体请咨询中国移动。</p>
      5、客服电话：4000968662<br />
      6、客服QQ：2810476497</p>
      <p><strong class="color_red">（客服人员不会以任何理由向用户索取游戏账号、密码、短信虚拟码）</strong><br />
	<p>&nbsp;</p>
</div>
    </div>
